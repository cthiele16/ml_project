...
def EDA(df, X, y, categorical_cols, numeric_cols):
    ...
    plt.tight_layout()
    plt.savefig(f"phases/results/EDA/ratio.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f"phases/results/EDA/histogram_numerical_features.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f"phases/results/EDA/distribultion_numerical_features.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f"phases/results/EDA/distribultion_categorical_features.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f"phases/results/EDA/distribultion_features_vs_target.png")
    plt.close()
    ...
    for ax in axes.flat[n:]:
        ax.set_visible(False)
    plt.tight_layout()
    plt.savefig(f"phases/results/EDA/defaultrate_per_category.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f"phases/results/EDA/heatmap.png")
    plt.close()
